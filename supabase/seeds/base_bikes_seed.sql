...
INSERT INTO base_bike_brands (name, slug, country, founded, description) VALUES
  ('Honda',           'honda',           'Japan',           1948, 'Zuverlässige Klassiker — perfekte Basis für Café Racer, Scrambler und Bobber.'),
  ('Yamaha',          'yamaha',          'Japan',           1955, 'Von der XSR bis zur SR500 — Yamaha liefert vielseitige Custom-Plattformen.'),
  ('Kawasaki',        'kawasaki',        'Japan',           1896, 'Robuste Technik zu fairen Preisen — ideal für erste Custom-Projekte.'),
  ('Suzuki',          'suzuki',          'Japan',           1909, 'Günstig, zuverlässig, anpassbar — Suzuki ist der Geheimtipp unter Custom Buildern.'),
  ('BMW',             'bmw',             'Deutschland',     1923, 'Ikonischer Boxer-Motor — seit Jahrzehnten die Wahl für Premium Custom Builds.'),
  ...
  ('Harley-Davidson', 'harley-davidson', 'USA',             1903, 'Amerikanische Ikone — unschlagbar als Basis für Bobber und Chopper.'),
  ('Moto Guzzi',     'moto-guzzi',      'Italien',         1921, 'Längseinbau-V2 aus Mandello del Lario — für Custom Builds mit Charakter.'),
  ...
  ('Indian',          'indian',          'USA',             1901, 'Amerikanische Tradition neu interpretiert — Scout und FTR für moderne Customs.'),
  ('KTM',             'ktm',             'Oesterreich',     1934, 'Leichte Einzylinder und V-Twins — perfekt für Tracker und Supermoto.'),
  ('Husqvarna',       'husqvarna',       'Schweden',        1903, 'Vitpilen und Svartpilen — ab Werk schon fast Custom.'),
  ('Norton',          'norton',          'Grossbritannien', 1898, 'Die Commando als Inbegriff des britischen Café Racers.'),
  ('BSA',             'bsa',             'Grossbritannien', 1919, 'Gold Star und A65 — britische Legenden für puristische Builds.'),
  ...
  ('Laverda',         'laverda',         'Italien',         1873, 'Die Jota als eine der schnellsten Serienmotorräder der 70er.'),
  ('Simson',          'simson',          'Deutschland',     1856, 'DDR-Kult — S51 und Schwalbe als beliebte Custom-Basis im DACH-Raum.'),
  ('Bultaco',         'bultaco',         'Spanien',         1958, 'Spanische Zweitakt-Legenden — Pursang und Metralla für puristische Builds.')
