...
export default function EventMap({ lat, lng, locationName }: Props) {
  ...
  useEffect(() => {
    ...
    if (wrapperRef.current) {
      map.addControl(new mapboxgl.FullscreenControl({ container: wrapperRef.current }), 'top-right')
    }
    ...
    new mapboxgl.Marker({ element: el, anchor: 'center' })
      ...
      .setPopup(
        new mapboxgl.Popup({ offset: 20, closeButton: false })
          .setHTML(`
            <div style="font-family: 'Plus Jakarta Sans', system-ui, sans-serif; padding: 4px 2px;">
              <p style="font-weight: 700; font-size: 13px; color: var(--color-text); margin: 0;">${escapeHtml(locationName)}</p>
            </div>
          `)
      )
      .addTo(map)
  ...
  return (
    <>
      <style>{`
        .eventmap-container .mapboxgl-ctrl-logo { display: none !important; }
        .eventmap-container .mapboxgl-ctrl-attrib { display: none !important; }
        .eventmap-container .mapboxgl-ctrl-top-right,
        .eventmap-container .mapboxgl-ctrl-top-left,
        .eventmap-container .mapboxgl-ctrl-bottom-right,
        .eventmap-container .mapboxgl-ctrl-bottom-left { z-index: 1 !important; }
        .eventmap-container .mapboxgl-ctrl-group {
          border: 1px solid #e5e5e5 !important;
          border-radius: 8px !important;
          overflow: hidden;
          box-shadow: 0 1px 4px rgba(0,0,0,0.06) !important;
        }
        .eventmap-container .mapboxgl-ctrl button { background: #fff !important; }
        .eventmap-container:fullscreen,
        .eventmap-container:-webkit-full-screen { background: #fff; }
        .eventmap-container:fullscreen > div:first-of-type,
        .eventmap-container:-webkit-full-screen > div:first-of-type { height: 100vh !important; min-height: 100vh !important; }
        .eventmap-container .mapboxgl-ctrl-zoom-in .mapboxgl-ctrl-icon {
        ...
        .eventmap-container .mapboxgl-ctrl-zoom-out .mapboxgl-ctrl-icon {
        ...
        .eventmap-container .mapboxgl-ctrl-fullscreen .mapboxgl-ctrl-icon {
        ...
        .eventmap-container .mapboxgl-ctrl-shrink .mapboxgl-ctrl-icon {
      ...
      `}</style>
      <div ref={wrapperRef} className="eventmap-container relative">
        <div
          ref={containerRef}
        ...
        {!activated && (
          <div
            ...
            className="absolute inset-0 cursor-pointer z-[1] flex items-end justify-center pb-4 transition-opacity"
          >
