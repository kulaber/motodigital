...
import { Wrench, Megaphone, Handshake } from 'lucide-react'
...
const CARDS = [
  {
    icon: <Wrench size={24} className="text-[#06a5a5]" />,
    title: 'Werkstatt eintragen',
    text: 'Präsentiere deine Builds auf der führenden Custom-Plattform im DACH-Raum — komplett kostenlos.',
    cta: 'Jetzt eintragen',
      ...
      <section className="bg-[#222222] overflow-hidden relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-5 lg:px-8 py-24 relative z-10">
          ...
          <p className="text-base text-white/40 max-w-lg leading-relaxed">
            Ob Werkstatt, Marke oder Veranstalter — hier findest du den richtigen Einstieg.
          </p>
        </div>
      </section>
