          ...
          <div className="flex flex-col gap-4">
            {EVENTS.map(event => (
              <a
                ...
                className={`group bg-[#1C1C1C] border border-[#F0EDE4]/6 hover:border-[#2aabab]/20 rounded-2xl p-6 transition-all duration-200 block ${event.url ? 'cursor-pointer' : 'cursor-default'}`}
              >
