...
function formatDateLocalized(iso: string, locale: string): string {
                ...
                <div className="relative h-[460px] sm:h-[540px] lg:h-[600px] overflow-hidden">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-8 sm:p-10">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <span className="text-[11px] text-white/50">{heroArticle.readTime} {t('readTime')}</span>
                    </div>
                    <h2
                    ...
                    <div className="flex items-center gap-3 text-[11px] text-white/40">
                      ...
                      <span>{formatDateLocalized(heroArticle.publishedAt, locale)}</span>
                    </div>
                  </div>
      ...
      <section className="pb-16 pt-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-5 lg:px-8">
          <div className="flex items-center justify-between mb-6">
            ...
            <span className="text-xs text-[#222222]/25">{t('postsCount', { count: restArticles.length })}</span>
          </div>
