    ...
    <div className="min-h-screen bg-white text-[#222222]">
      ...
      <div className="hidden lg:flex" style={{ height: 'calc(100dvh - 128px)' }}>
        ...
        <div className="w-1/2 overflow-hidden border-r border-[#EBEBEB] p-4">
          <div className="h-3 w-32 bg-[#F0F0F0] animate-pulse rounded mb-4" />
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {[...Array(4)].map((_, i) => (
              <div key={i}>
                <div className="aspect-[4/3] rounded-xl bg-[#F0F0F0] animate-pulse mb-2.5" />
                <div className="h-4 w-2/3 bg-[#F0F0F0] animate-pulse rounded mb-1" />
                <div className="h-3 w-1/2 bg-[#F0F0F0] animate-pulse rounded mb-1.5" />
