    ...
    <div className="min-h-screen bg-[#F5F2EB] text-[#1A1714]">
      ...
      <section className="pt-24 pb-14 px-4 sm:px-5 lg:px-8 text-center relative overflow-hidden">
        ...
        <div className="max-w-2xl mx-auto relative">
          ...
          <h1 className="font-bold text-[#1A1714] leading-tight mb-4"
            style={{ fontSize: 'clamp(1.75rem, 4vw, 3rem)', letterSpacing: '-0.03em' }}>
            Einfach. Transparent.<br />
            <span className="text-[#1A1714]/25">Kostenlos starten.</span>
          </h1>
          <p className="text-[#1A1714]/45 text-base leading-relaxed">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-5 lg:px-8 pb-20">
        ...
        {/* Builder plans */}
        <div className="mb-16">
          <p className="text-[10px] font-bold uppercase tracking-widest text-[#1A1714]/25 mb-6 text-center">Für Builder & Workshops</p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-3xl mx-auto">

            {/* Free */}
            <div className="bg-white border border-[#1A1714]/6 rounded-2xl p-6">
              <div className="mb-6">
                <p className="text-xs font-semibold text-[#1A1714]/35 uppercase tracking-widest mb-1">Free</p>
                <div className="flex items-end gap-1.5">
                  <span className="text-4xl font-bold text-[#1A1714]">0 €</span>
                  <span className="text-sm text-[#1A1714]/30 mb-1.5">/ Monat</span>
                </div>
                <p className="text-xs text-[#1A1714]/35 mt-1">Für immer kostenlos</p>
              </div>
              <a href="/auth/register"
                className="block w-full text-center text-sm font-semibold bg-[#1A1714]/8 border border-[#1A1714]/12 text-[#1A1714]/70 hover:text-[#1A1714] hover:border-[#1A1714]/25 py-2.5 rounded-full transition-all mb-6">
                Jetzt registrieren
              </a>
                ...
                {BUILDER_FREE.map(f => (
                  <li key={f.label} className="flex items-center gap-2.5">
                    {f.included
                      ...
                      : <X size={13} className="text-[#1A1714]/15 flex-shrink-0" />
                    }
                    <span className={`text-sm ${f.included ? 'text-[#1A1714]/60' : 'text-[#1A1714]/20'}`}>
                      {f.label}
                    </span>
                  </li>
                ))}
            ...
            {/* Pro */}
            <div className="bg-white border border-[#2AABAB]/30 rounded-2xl p-6 relative overflow-hidden">
              ...
              <div className="mb-6 relative">
                ...
                <div className="flex items-end gap-1.5">
                  <span className="text-4xl font-bold text-[#1A1714]">TBD</span>
                </div>
                <p className="text-xs text-[#1A1714]/35 mt-1">Wird bekannt gegeben</p>
              </div>
              <button disabled
              ...
              <ul className="flex flex-col gap-3">
                {BUILDER_PRO.map(f => (
                  <li key={f.label} className="flex items-center gap-2.5">
                    <Check size={13} className="text-[#2AABAB] flex-shrink-0" />
                    <span className="text-sm text-[#1A1714]/60">{f.label}</span>
                  </li>
                ))}
              </ul>
            </div>
        ...
        <div className="max-w-3xl mx-auto mb-16">
          <p className="text-[10px] font-bold uppercase tracking-widest text-[#1A1714]/25 mb-6 text-center">Für Rider</p>
          <div className="bg-white border border-[#1A1714]/6 rounded-2xl p-6">
            <div className="flex items-center justify-between mb-6 flex-wrap gap-4">
              ...
              <a href="/auth/register"
                className="inline-flex items-center gap-2 text-sm font-semibold bg-[#1A1714]/8 border border-[#1A1714]/12 text-[#1A1714]/70 hover:text-[#1A1714] hover:border-[#1A1714]/25 px-5 py-2.5 rounded-full transition-all">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {RIDER_FEATURES.map(f => (
                <div key={f} className="flex items-center gap-2.5">
                  <Check size={13} className="text-[#2AABAB] flex-shrink-0" />
                  <span className="text-sm text-[#1A1714]/60">{f}</span>
                </div>
              ))}
            </div>
          </div>
        ...
        {/* FAQ / CTA */}
        <div className="bg-white border border-[#1A1714]/6 rounded-2xl p-8 text-center max-w-3xl mx-auto relative overflow-hidden">
          ...
          <h2 className="text-xl font-bold text-[#1A1714] mb-2">Jetzt kostenlos starten</h2>
          <p className="text-sm text-[#1A1714]/40 leading-relaxed mb-6 max-w-md mx-auto">
