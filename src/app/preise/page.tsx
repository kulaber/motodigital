    ...
    <div className="min-h-screen bg-white text-[#222222]">
      ...
      <section className="pt-24 pb-14 px-4 sm:px-5 lg:px-8 text-center relative overflow-hidden">
        ...
        <div className="max-w-2xl mx-auto relative">
          ...
          <p className="text-[#222222]/45 text-base leading-relaxed">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-5 lg:px-8 pb-20">
        ...
        {/* Builder plans */}
        <div className="mb-16">
          <p className="text-[10px] font-bold uppercase tracking-widest text-[#222222]/25 mb-6 text-center">Für Builder & Workshops</p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-3xl mx-auto">
            ...
            <div className="bg-white border border-[#222222]/6 rounded-2xl p-6">
              ...
              <a href="/auth/register"
                className="block w-full text-center text-sm font-semibold bg-[#222222]/8 border border-[#222222]/12 text-[#222222]/70 hover:text-[#222222] hover:border-[#222222]/25 py-2.5 rounded-full transition-all mb-6">
                Jetzt registrieren
              </a>
            ...
            <div className="bg-white border border-[#DDDDDD]/30 rounded-2xl p-6 relative overflow-hidden">
              ...
              <div className="mb-6 relative">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="text-[9px] font-bold uppercase tracking-widest bg-[#222222]/15 text-[#717171] border border-[#DDDDDD]/25 px-2 py-0.5 rounded-full">
                    Bald verfügbar
                  </span>
                </div>
                <div className="flex items-end gap-1.5">
        ...
        <div className="max-w-3xl mx-auto mb-16">
          <p className="text-[10px] font-bold uppercase tracking-widest text-[#222222]/25 mb-6 text-center">Für Rider</p>
          <div className="bg-white border border-[#222222]/6 rounded-2xl p-6">
            <div className="flex items-center justify-between mb-6 flex-wrap gap-4">
              ...
              <a href="/auth/register"
                className="inline-flex items-center gap-2 text-sm font-semibold bg-[#222222]/8 border border-[#222222]/12 text-[#222222]/70 hover:text-[#222222] hover:border-[#222222]/25 px-5 py-2.5 rounded-full transition-all">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {RIDER_FEATURES.map(f => (
                <div key={f} className="flex items-center gap-2.5">
                  <Check size={13} className="text-[#717171] flex-shrink-0" />
                  <span className="text-sm text-[#222222]/60">{f}</span>
                </div>
              ))}
            </div>
          </div>
