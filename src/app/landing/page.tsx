          ...
          <div className="max-w-2xl">
            ...
            <div className="animate-slide-up flex flex-col sm:flex-row gap-3 mb-12" style={{ animationDelay: '180ms' }}>
              <Link href="/auth/register"
                className="bg-[#086565] text-white font-semibold px-7 py-3.5 rounded-full text-sm text-center hover:bg-[#075555] transition-colors duration-200 hover:-translate-y-0.5 transform min-h-[44px] flex items-center justify-center">
                Jetzt kostenlos registrieren
              </Link>
              <Link href="/builder"
                className="border border-white/25 text-white font-medium px-7 py-3.5 rounded-full text-sm text-center hover:border-[#DDDDDD] hover:text-[#717171] transition-colors duration-200 min-h-[44px] flex items-center justify-center">
                Bikes entdecken
              </Link>
            </div>
      ...
      <section className="py-20 lg:py-28 bg-white" id="builder">
        <div className="max-w-6xl mx-auto px-5 lg:px-8">
          <AnimateIn className="flex items-end justify-between mb-10 gap-4">
            ...
            <Link href="/builder" className="flex-shrink-0 border border-[#222222]/15 text-[#222222]/60 hover:text-[#222222] hover:border-[#222222]/30 text-sm font-medium px-5 py-2.5 rounded-full transition-colors duration-200">
              Alle Builder →
            </Link>
          </AnimateIn>
            ...
            {BUILDERS.slice(0, 3).map((b, i) => (
              <AnimateIn key={b.slug} delay={i * 70}>
                <Link href={`/builder/${b.slug}`}
                  className="group bg-white border border-[#222222]/6 rounded-2xl p-5 hover:border-[#DDDDDD]/25 hover:-translate-y-0.5 transition-all duration-200 block h-full">
      ...
      <section className="py-20 lg:py-28 bg-white relative overflow-hidden" id="waitlist">
        ...
        <AnimateIn className="max-w-md mx-auto px-5 relative z-10">
          <div className="text-center mb-8">
            <div className="w-14 h-14 bg-[#086565] rounded-2xl flex items-center justify-center text-white font-bold text-xl mx-auto mb-5">M</div>
...
function WaitlistForm() {
  return (
    <form action="/api/waitlist" method="POST" className="flex flex-col gap-4">
      ...
      <button type="submit"
        className="w-full bg-[#086565] text-white font-semibold py-3 rounded-full text-sm hover:bg-[#075555] transition-colors duration-200 mt-1 min-h-[44px]">
