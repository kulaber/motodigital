...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://motodigital.vercel.app/magazine/build-story',
  },
  openGraph: {
    title: meta.title,
    description: meta.description,
...
const jsonLd = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Build Stories', item: 'https://motodigital.vercel.app/magazine/build-story' },
  ],
}
